      ...
      <div className="border border-white/10 relative overflow-hidden bg-white/5 backdrop-blur-xl">
        ...
        <header className="relative z-10 text-center mb-6">
          ...
          <p className="text-gray-400 text-sm mt-2">
            Paso {step} de 2: {step === 1 ? "Información Personal" : "Credenciales de Acceso"}
          </p>
        </header>

        {/* INDICADOR VISUAL DE PASO (STEP PROGRESS BAR) */}
          ...
          {step === 2 && (
            <div className="space-y-5 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <div className="space-y-2">
                ...
                {errorEmail && (
                  <p className="text-red-400 text-xs pl-1 animate-in fade-in slide-in-from-top-1">{errorEmail}</p>
                )}
              </div>
